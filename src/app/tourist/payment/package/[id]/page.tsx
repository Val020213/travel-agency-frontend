...
import { ExtendedInputPackages } from '@/components/app/tourist/payment/touristPackage/ExtendPackageInputs';
...
export default function Page({ params }: { params: { id: string } }) {
  ...
  const initialState: TouristPackageState = {};
