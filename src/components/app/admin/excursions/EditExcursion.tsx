...
export async function EditExcursion({ departureLocation, arrivalLocation, departureDate, arrivalDate, departureTime, arrivalTime, hotelID, id }: { departureLocation: string, arrivalLocation: string, departureDate: string, arrivalDate: string, departureTime: string, arrivalTime: string, hotelID?: number, id: number }) {
