...
const MoonSwitch = () => {
  return (
    ...
    >
      <IconMoonFilled className='hover:drop-shadow-white text-white' size={30} />
    </div>
  );
};
...
export const Switch = () => {
  const [theme, setTheme] = useState<string>(useTheme());

  return (
    <button onClick={() => { ChangeTheme(); setTheme(useTheme) }}>
